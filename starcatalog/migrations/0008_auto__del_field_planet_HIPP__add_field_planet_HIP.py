...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Planet.HIPP'
        db.delete_column('starcatalog_planet', 'HIPP')

        # Adding field 'Planet.HIP'
        db.add_column('starcatalog_planet', 'HIP',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Planet.HIPP'
        db.add_column('starcatalog_planet', 'HIPP',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Planet.HIP'
        db.delete_column('starcatalog_planet', 'HIP')
