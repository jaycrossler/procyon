...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Planet', fields ['HIP']
        db.create_index('starcatalog_planet', ['HIP'])

        # Adding index on 'Planet', fields ['name']
        db.create_index('starcatalog_planet', ['name'])

        # Adding index on 'Planet', fields ['HR']
        db.create_index('starcatalog_planet', ['HR'])

        # Adding index on 'Planet', fields ['gliese']
        db.create_index('starcatalog_planet', ['gliese'])

        # Adding index on 'Planet', fields ['other_name']
        db.create_index('starcatalog_planet', ['other_name'])

        # Adding index on 'Planet', fields ['mass']
        db.create_index('starcatalog_planet', ['mass'])

        # Adding index on 'Planet', fields ['kepler_id']
        db.create_index('starcatalog_planet', ['kepler_id'])

        # Adding index on 'Planet', fields ['HD']
        db.create_index('starcatalog_planet', ['HD'])


    def backwards(self, orm):
        # Removing index on 'Planet', fields ['HD']
        db.delete_index('starcatalog_planet', ['HD'])

        # Removing index on 'Planet', fields ['kepler_id']
        db.delete_index('starcatalog_planet', ['kepler_id'])

        # Removing index on 'Planet', fields ['mass']
        db.delete_index('starcatalog_planet', ['mass'])

        # Removing index on 'Planet', fields ['other_name']
        db.delete_index('starcatalog_planet', ['other_name'])

        # Removing index on 'Planet', fields ['gliese']
        db.delete_index('starcatalog_planet', ['gliese'])

        # Removing index on 'Planet', fields ['HR']
        db.delete_index('starcatalog_planet', ['HR'])

        # Removing index on 'Planet', fields ['name']
        db.delete_index('starcatalog_planet', ['name'])

        # Removing index on 'Planet', fields ['HIP']
        db.delete_index('starcatalog_planet', ['HIP'])
