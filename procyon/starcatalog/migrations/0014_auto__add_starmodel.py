...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'starcatalog_starmodel', (
            ...
            ('star_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['starcatalog.Star'], unique=True)),
    ...
    models = {
        ...
        u'starcatalog.starmodel': {
            'Meta': {'ordering': "['star_id']", 'object_name': 'StarModel'},
            'base_color': ('django.db.models.fields.CharField', [], {'default': "'#ffddbe'", 'max_length': '8', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'star_id': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['starcatalog.Star']", 'unique': 'True'}),
