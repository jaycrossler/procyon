...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Star.star_type'
        db.add_column(u'starcatalog_star', 'star_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['starcatalog.StarType'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Star.star_type'
        db.delete_column(u'starcatalog_star', 'star_type_id')
