...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Planet.planet_id'
        db.add_column('starcatalog_planet', 'planet_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Planet.planet_id'
        db.delete_column('starcatalog_planet', 'planet_id')
    ...
    models = {
        'starcatalog.planet': {
            ...
            'planet_id': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
