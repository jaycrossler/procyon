...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'starcatalog_starmodel')
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'starcatalog_planetmodel', (
            ...
            ('name', self.gf('django.db.models.fields.CharField')(blank=True, max_length=60, null=True, db_index=True)),
            ...
            ('mass', self.gf('django.db.models.fields.FloatField')(blank=True, null=True, db_index=True)),
            ('orbital_period', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('other_name', self.gf('django.db.models.fields.CharField')(blank=True, max_length=60, null=True, db_index=True)),
        ...
        db.create_table(u'starcatalog_starmodel', (
        ...
        db.send_create_signal(u'starcatalog', ['StarModel'])
