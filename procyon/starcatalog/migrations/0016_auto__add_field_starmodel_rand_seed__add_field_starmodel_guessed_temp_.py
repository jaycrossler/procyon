...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StarModel.rand_seed'
        db.add_column(u'starcatalog_starmodel', 'rand_seed',
                      self.gf('django.db.models.fields.FloatField')(default=0, null=True, blank=True),
                      keep_default=False)

        # Adding field 'StarModel.guessed_temp'
        db.add_column(u'starcatalog_starmodel', 'guessed_temp',
                      self.gf('django.db.models.fields.FloatField')(default=0, null=True, blank=True),
                      keep_default=False)

        # Adding field 'StarModel.guessed_mass'
        db.add_column(u'starcatalog_starmodel', 'guessed_mass',
                      self.gf('django.db.models.fields.FloatField')(default=0, null=True, blank=True),
                      keep_default=False)

        # Adding field 'StarModel.guessed_radius'
        db.add_column(u'starcatalog_starmodel', 'guessed_radius',
                      self.gf('django.db.models.fields.FloatField')(default=0, null=True, blank=True),
                      keep_default=False)

        # Adding field 'StarModel.guessed_luminosity'
        db.add_column(u'starcatalog_starmodel', 'guessed_luminosity',
                      self.gf('django.db.models.fields.FloatField')(default=0, null=True, blank=True),
                      keep_default=False)

        # Adding field 'StarModel.guessed_age'
        db.add_column(u'starcatalog_starmodel', 'guessed_age',
                      self.gf('django.db.models.fields.FloatField')(default=0, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StarModel.rand_seed'
        db.delete_column(u'starcatalog_starmodel', 'rand_seed')

        # Deleting field 'StarModel.guessed_temp'
        db.delete_column(u'starcatalog_starmodel', 'guessed_temp')

        # Deleting field 'StarModel.guessed_mass'
        db.delete_column(u'starcatalog_starmodel', 'guessed_mass')

        # Deleting field 'StarModel.guessed_radius'
        db.delete_column(u'starcatalog_starmodel', 'guessed_radius')

        # Deleting field 'StarModel.guessed_luminosity'
        db.delete_column(u'starcatalog_starmodel', 'guessed_luminosity')

        # Deleting field 'StarModel.guessed_age'
        db.delete_column(u'starcatalog_starmodel', 'guessed_age')
