...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'StarModel.star_id'
        db.delete_column(u'starcatalog_starmodel', 'star_id_id')

        # Adding field 'StarModel.star'
        db.add_column(u'starcatalog_starmodel', 'star',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['starcatalog.Star'], unique=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'StarModel.star_id'
        db.add_column(u'starcatalog_starmodel', 'star_id',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['starcatalog.Star'], unique=True),
                      keep_default=False)

        # Deleting field 'StarModel.star'
        db.delete_column(u'starcatalog_starmodel', 'star_id')
