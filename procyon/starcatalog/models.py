...
class Star(models.Model):
    ...
    mag = models.FloatField(help_text="Brightness from Earth (-1 is brightest, 10 is dark. 5 steps = 100x difference)", blank=True, null=True)
    abs_mag = models.FloatField(help_text="Brightness from 10 parsecs (-11 is brightest, 19 is darkest. 5 steps = 100x difference)", blank=True, null=True)
