...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Component.effects'
        db.alter_column(u'stories_component', 'effects', self.gf('jsonfield.fields.JSONField')(null=True))

    def backwards(self, orm):

        # Changing field 'Component.effects'
        db.alter_column(u'stories_component', 'effects', self.gf('jsonfield.fields.JSONField')())
    ...
    models = {
        ...
        u'stories.component': {
            ...
            'effects': ('jsonfield.fields.JSONField', [], {'null': 'True', 'blank': 'True'}),
