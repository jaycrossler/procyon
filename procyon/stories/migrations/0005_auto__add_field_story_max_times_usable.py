...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Story.max_times_usable'
        db.add_column(u'stories_story', 'max_times_usable',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Story.max_times_usable'
        db.delete_column(u'stories_story', 'max_times_usable')
