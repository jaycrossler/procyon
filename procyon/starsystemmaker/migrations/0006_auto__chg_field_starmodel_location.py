...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'StarModel.location'
        db.alter_column(u'starsystemmaker_starmodel', 'location', self.gf('django.contrib.gis.db.models.fields.PointField')(srid=0, dim=3, null=True))

    def backwards(self, orm):

        # Changing field 'StarModel.location'
        db.alter_column(u'starsystemmaker_starmodel', 'location', self.gf('django.contrib.gis.db.models.fields.PointField')(dim=3, null=True))
    ...
    models = {
        ...
        u'starsystemmaker.starmodel': {
            ...
            'location': ('django.contrib.gis.db.models.fields.PointField', [], {'srid': '0', 'dim': '3', 'null': 'True', 'blank': 'True'}),
