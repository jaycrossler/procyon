...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'starsystemmaker_starmodel', 'guessed_luminosity')

        # Adding field 'StarModel.luminosity_class'
        db.add_column(u'starsystemmaker_starmodel', 'luminosity_class',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['starcatalog.StarLuminosityType'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'StarModel.ids_of_companion_stars'
        db.add_column(u'starsystemmaker_starmodel', 'ids_of_companion_stars',
                      self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True),
                      keep_default=False)

        # Adding index on 'StarModel', fields ['location']
        db.create_index(u'starsystemmaker_starmodel', ['location'])


    def backwards(self, orm):
        # Removing index on 'StarModel', fields ['location']
        db.delete_index(u'starsystemmaker_starmodel', ['location'])

        # Adding field 'StarModel.guessed_luminosity'
        db.add_column(u'starsystemmaker_starmodel', 'guessed_luminosity',
                      self.gf('django.db.models.fields.FloatField')(default=0, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'StarModel.luminosity_class'
        db.delete_column(u'starsystemmaker_starmodel', 'luminosity_class_id')

        # Deleting field 'StarModel.ids_of_companion_stars'
        db.delete_column(u'starsystemmaker_starmodel', 'ids_of_companion_stars')
