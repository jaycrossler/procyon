...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StarModel.luminosity_mod'
        db.add_column(u'starsystemmaker_starmodel', 'luminosity_mod',
                      self.gf('django.db.models.fields.CharField')(max_length=5, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StarModel.luminosity_mod'
        db.delete_column(u'starsystemmaker_starmodel', 'luminosity_mod')
