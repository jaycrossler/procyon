...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'PlanetModel.solid_corex_type'
        db.delete_column(u'starsystemmaker_planetmodel', 'solid_corex_type')

        # Adding field 'PlanetModel.solid_core_type'
        db.add_column(u'starsystemmaker_planetmodel', 'solid_core_type',
                      self.gf('django.db.models.fields.CharField')(default='Iron', max_length=30, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PlanetModel.surface_ocean_chemicals'
        db.add_column(u'starsystemmaker_planetmodel', 'surface_ocean_chemicals',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PlanetModel.ring_size'
        db.add_column(u'starsystemmaker_planetmodel', 'ring_size',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PlanetModel.ring_numbers'
        db.add_column(u'starsystemmaker_planetmodel', 'ring_numbers',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PlanetModel.atmosphere_millibars'
        db.add_column(u'starsystemmaker_planetmodel', 'atmosphere_millibars',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PlanetModel.atmosphere_main_gas'
        db.add_column(u'starsystemmaker_planetmodel', 'atmosphere_main_gas',
                      self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PlanetModel.atmosphere_secondary_gas'
        db.add_column(u'starsystemmaker_planetmodel', 'atmosphere_secondary_gas',
                      self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PlanetModel.atmosphere_tertiary_gas'
        db.add_column(u'starsystemmaker_planetmodel', 'atmosphere_tertiary_gas',
                      self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PlanetModel.atmosphere_dust_amount'
        db.add_column(u'starsystemmaker_planetmodel', 'atmosphere_dust_amount',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PlanetModel.surface_wind_speeds_avg'
        db.add_column(u'starsystemmaker_planetmodel', 'surface_wind_speeds_avg',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PlanetModel.surface_wind_speeds_max'
        db.add_column(u'starsystemmaker_planetmodel', 'surface_wind_speeds_max',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'PlanetModel.solid_corex_type'
        db.add_column(u'starsystemmaker_planetmodel', 'solid_corex_type',
                      self.gf('django.db.models.fields.CharField')(default='Iron', max_length=30, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'PlanetModel.solid_core_type'
        db.delete_column(u'starsystemmaker_planetmodel', 'solid_core_type')

        # Deleting field 'PlanetModel.surface_ocean_chemicals'
        db.delete_column(u'starsystemmaker_planetmodel', 'surface_ocean_chemicals')

        # Deleting field 'PlanetModel.ring_size'
        db.delete_column(u'starsystemmaker_planetmodel', 'ring_size')

        # Deleting field 'PlanetModel.ring_numbers'
        db.delete_column(u'starsystemmaker_planetmodel', 'ring_numbers')

        # Deleting field 'PlanetModel.atmosphere_millibars'
        db.delete_column(u'starsystemmaker_planetmodel', 'atmosphere_millibars')

        # Deleting field 'PlanetModel.atmosphere_main_gas'
        db.delete_column(u'starsystemmaker_planetmodel', 'atmosphere_main_gas')

        # Deleting field 'PlanetModel.atmosphere_secondary_gas'
        db.delete_column(u'starsystemmaker_planetmodel', 'atmosphere_secondary_gas')

        # Deleting field 'PlanetModel.atmosphere_tertiary_gas'
        db.delete_column(u'starsystemmaker_planetmodel', 'atmosphere_tertiary_gas')

        # Deleting field 'PlanetModel.atmosphere_dust_amount'
        db.delete_column(u'starsystemmaker_planetmodel', 'atmosphere_dust_amount')

        # Deleting field 'PlanetModel.surface_wind_speeds_avg'
        db.delete_column(u'starsystemmaker_planetmodel', 'surface_wind_speeds_avg')

        # Deleting field 'PlanetModel.surface_wind_speeds_max'
        db.delete_column(u'starsystemmaker_planetmodel', 'surface_wind_speeds_max')
