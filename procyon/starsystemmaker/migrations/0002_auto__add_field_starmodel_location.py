...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StarModel.location'
        db.add_column(u'starsystemmaker_starmodel', 'location',
                      self.gf('django.contrib.gis.db.models.fields.PointField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StarModel.location'
        db.delete_column(u'starsystemmaker_starmodel', 'location')
